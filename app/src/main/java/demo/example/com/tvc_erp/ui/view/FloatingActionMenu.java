...
import demo.example.com.tvc_erp.ui.animation.DefaultAnimationHandler;
import demo.example.com.tvc_erp.ui.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
     ...
     * @param animated
     */
    private String LOG = "FLOATINGACTIONMENU";
...
//        open(true);
    ...
    private Point calculateItemPositions() {
        ...
        Log.i(LOG,"calculateItemPositions " + radius + " " + area.width() + " " + area.height());
        Path orbit = new Path();
        orbit.addArc(area, startAngle, endAngle - startAngle);
        Log.i(LOG,"calculateItemPositions " + startAngle + " " + endAngle + " " );
    ...
    private void addViewToCurrentContainer(View view, ViewGroup.LayoutParams layoutParams) {
        if (systemOverlay) {
//            if (theNumberOfDrap < 4) {
//                theNumberOfDrap++;
//                view.setLayoutParams(layoutParams);
//                Log.i(LOG, "setLayoutParams" + " " + theNumberOfDrap);
//            } else {
...
//            }
    ...
    public int getTheNumberOfDrap() {
        return theNumberOfDrap;
    }

    public void setTheNumberOfDrap(int theNumberOfDrap) {
        this.theNumberOfDrap = theNumberOfDrap;
    }
