...
public class CirleImageView extends ImageView {
    ...
    public CirleImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CirleImageView, defStyle, 0);
        ...
        mFillColor = a.getColor(R.styleable.CirleImageView_civ_fill_color, DEFAULT_FILL_COLOR);
